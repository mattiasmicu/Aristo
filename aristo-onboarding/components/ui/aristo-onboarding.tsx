...
// --- TYPE DEFINITIONS ---
interface AristoOnboardingProps {
...
// --- MAIN COMPONENT ---
export const AristoOnboarding: React.FC<AristoOnboardingProps> = ({
    ...
    <div className="h-[100dvh] flex items-center justify-center font-sans w-[100dvw] p-4 md:p-8">
      ...
      <section className="w-full max-w-md lg:max-w-2xl">
        <div className="flex flex-col gap-6">
          ...
          <div
            className={`min-h-64 transition-all duration-300 ${isTransitioning ? "opacity-0 translate-x-4" : "opacity-100 translate-x-0"}`}
          >
            {currentStep === 1 && (
              <Step1
                language={language}
